...
export default function PropertyListing() {
  ...
  return (
    <div className="container mx-auto pt-20 px-4 bg-gray-100">
      <h1 className="text-4xl font-bold text-center text-black mb-4">Property Listing</h1>
      <p className="text-center text-black mb-8">
        Welcome to our property listing. Browse all available properties.
      </p>
